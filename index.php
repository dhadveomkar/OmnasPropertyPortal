...
<!--	Title
	=========================================================-->
<title>Omnas Property Portal</title>
</head>
<body>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>
                                        Omnas Property Portal, India’s No. 1 property portal, deals with every aspect of the consumers’ needs in the real estate industry. It is an online forum where buyers, sellers and brokers/agents can exchange information about real estate properties quickly, effectively and inexpensively. 
                                    </p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>
                                            We can verify each property for better experiences
                                ...
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>
                                            We can manage verify and certify agents for our property portal
                                        </p>
									</div>
                                </li>
                            </ul>
